...
QT_MOC_LITERAL(27, 0), // ""
QT_MOC_LITERAL(28, 15), // "replayRequested"
QT_MOC_LITERAL(44, 10) // "channel_id"

    },
    "VideoWidget\0closeRequested\0\0replayRequested\0"
    "channel_id"
};
...
void VideoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoWidget::closeRequested)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoWidget::replayRequested)) {
                *result = 1;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<VideoWidget, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>
...
// SIGNAL 0
void VideoWidget::closeRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void VideoWidget::replayRequested(int _t1)
{
